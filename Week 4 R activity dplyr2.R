...
library(datasets)
data(ChickWeight)
RodrigoWeek4 <- data.frame(ChickWeight)
...
select(RodrigoWeek4, weight, Time)
...
RodrigoWeek4weighttime <- data.frame(select(RodrigoWeek4, weight, Time))
...
arrange(RodrigoWeek4, desc(weight))
